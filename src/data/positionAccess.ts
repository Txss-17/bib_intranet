...
export const positionAccess: Record<EmployeePosition, PositionAccess> = {
  supplier_manager: {
    ...
    screens: [
      'supplier.overview',
      'supplier.inbox-catalogues',
      'supplier.fiche-fournisseur',
      'supplier.validation-produit',
      'supplier.pending',
      'supplier.validated',
      'supplier.suppliers',
      ...
      'supplier.decisions',
      'supplier.alerts',
      'supplier.transmission-tech'
    ],
    restricted: [
      'finance.*',
      'lifecycle.comptes-utilisateurs',
      'rh.*'
    ]
  },
  user_success_manager: {
    ...
    screens: [
      'lifecycle.overview',
      'lifecycle.user-accounts',
      'lifecycle.risk-alerts',
      'lifecycle.email-campaigns',
      'lifecycle.trustpilot',
      'lifecycle.support',
  ...
  rse_packaging_manager: {
    ...
    screens: [
      'rse.overview',
      'rse.packaging',
      'rse.packaging-validation',
      'rse.recycling',
      'rse.points',
      'rse.co2',
      'rse.esg',
      'rse.transmission-ops',
      'modules.packaging'
    ],
    restricted: [
      'finance.*',
