...
export const jobRoles: JobRole[] = [
...

  {
    ...
    department: 'direction',
    position: 'product_engineering_manager',
...

  {
    ...
    department: 'direction',
    position: 'customer_success_manager',
...

  {
    ...
    position: 'marketing_communication_manager',
    poles: ['marketing'],
    seniority: 'lead',
    priority: 15,
